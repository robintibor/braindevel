...
from braindevel.mywyrm.processing import create_cnt_y_start_end_marker,\
    resample_cnt, lowpass_cnt
from braindevel.datasets.sensor_positions import get_nico_sensors
from braindevel.datasets.trial_segmenter import MarkerSegmenter
import logging

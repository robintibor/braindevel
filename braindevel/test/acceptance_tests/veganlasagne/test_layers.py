...
import numpy as np
from braindevel.veganlasagne.layers import StrideReshapeLayer, FinalReshapeLayer
from braindevel.test.util import to_4d_time_array, equal_without_nans,\
    allclose_without_nans
    
from lasagne.nonlinearities import softmax, identity
from numpy.random import RandomState
from braindevel.veganlasagne.pool import SumPool2dLayer
from braindevel.veganlasagne.nonlinearities import safe_log

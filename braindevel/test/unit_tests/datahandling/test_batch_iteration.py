...
from braindevel.datahandling.batch_iteration import WindowsIterator,\
    CntWindowTrialIterator
from braindevel.datasets.pylearn import DenseDesignMatrixWrapper
from braindevel.datahandling.batch_iteration import CntWindowsFromCntIterator
from braindevel.test.util import to_4d_time_array

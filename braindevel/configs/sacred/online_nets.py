...
from braindevel.datasets.combined import construct_folder_combined_set
from braindevel.mywyrm.processing import resample_cnt, bandpass_cnt, \
    exponential_standardize_cnt
from braindevel.veganlasagne.layers import get_n_sample_preds
from braindevel.veganlasagne.monitors import Monitor, \
    compute_preds_per_trial, LossMonitor, RuntimeMonitor
from braindevel.datahandling.splitters import SeveralSetsSplitter
from braindevel.datahandling.batch_iteration import \
    BalancedCntWindowTrialIterator
from braindevel.veganlasagne.objectives import sum_of_losses, \
    tied_neighbours_cnt_model_masked
from braindevel.configs.sacred.deep_shallow_hybrid import * # PARENTCONFIG
from braindevel.configs.sacred.online import *  # PARENTCONFIG
from braindevel.veganlasagne.stopping import Or, NoDecrease, MaxEpochs
from braindevel.veganlasagne.update_modifiers import \

from braindevel.experiments.parse import product_of_list_of_lists_of_dicts
import pickle
import time
from braindevel.datasets.loaders import BBCIDataset
from braindevel.csp.experiment import CSPExperiment
from braindevel.mywyrm.clean import NoCleaner, ChanMaxAbsVarCleaner

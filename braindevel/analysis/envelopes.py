...
from braindevel.datasets.generate_filterbank import generate_filterbank
from braindevel.analysis.util import (lowpass_topo,
                                       bandpass_topo)
from braindevel.analysis.stats import corr
from braindevel.datasets.pylearn import DenseDesignMatrixWrapper
from braindevel.results.results import ResultPool
from braindevel.analysis.kaggle import  transform_to_trial_acts
import lasagne
from braindevel.veganlasagne.layer_util import get_receptive_field_size
...
def load_trial_env(env_file_name, model, i_layer, train_set, 
        n_inputs_per_trial, square_before_mean):

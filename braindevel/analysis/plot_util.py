...
from braindevel.datasets.sensor_positions import (get_C_sensors_sorted,
    get_sensor_pos, tight_C_positions, cap_positions)
from braindevel.results.results import (
...
import seaborn
from braindevel.analysis.pandas_util import load_results_for_df,\

...
from braindevel.analysis.envelopes import load_trial_env, compute_topo_corrs
from braindevel.veganlasagne.layer_util import compute_trial_acts
...
def create_env_corrs(folder_name, params, start, stop):
    from braindevel.analysis.create_env_class_corrs import create_env_class_corr_file
    res_pool = ResultPool()

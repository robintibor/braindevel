...
"""
This is a script to make hyperparameter optimization with braindevel.
"""
import logging
import os
...
if __name__ == "__main__":
    params = {'dataset': '**raw_set',
         ...
         'num_folds': 10,
         'i_test_fold': 9,
         'template_name': '/home/schirrmr/braindevel/code/braindevel/hyperopt/robin_rawnet/templates.yaml'}

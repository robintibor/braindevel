...
from braindevel.experiments.experiment import Experiment, ExperimentCrossValidation,\
    load_layers_from_dict
from braindevel.results.results import Result
from braindevel.datasets.grasp_lift import (KaggleGraspLiftSet,
...
from braindevel.veganlasagne.stopping import MaxEpochs
from braindevel.datahandling.splitters import FixedTrialSplitter,\
    SeveralSetsSplitter
import logging
from braindevel.util import dict_equal, touch_file
from braindevel.paper.confusion_mat import compute_pred_target_labels_for_cnt_exp,\
...
class ExperimentsRunner:
    ...
    def _log_only_warnings(self):
        ...
        logging.getLogger("braindevel").setLevel(logging.WARN)
    ...
    def _run_experiments_with_string(self, experiment_index, train_str):
        ...
        # create experiment with max epochs 2, run
            from braindevel.datasets.random import RandomSet
...
#                 from braindevel.epilepsy.experiment import EpilepsyExperiment

...
from braindevel.mywyrm.processing import (
    resample_cnt, common_average_reference_cnt, exponential_standardize_cnt,
    set_channel_to_zero)
from braindevel.mywyrm.clean import (NoCleaner, clean_train_test_cnt)
import itertools
from sklearn.cross_validation import KFold
from braindevel.csp.pipeline import (BinaryCSP, FilterbankCSP,

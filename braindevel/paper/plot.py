...
from braindevel.mywyrm.plot import ax_scalp
from braindevel.paper import map_i_class_pair, resorted_class_names
from copy import deepcopy
from braindevel.datasets.sensor_positions import CHANNEL_10_20_APPROX
from braindevel.mywyrm.plot import add_ears, get_channelpos
...
def plot_confusion_matrix_paper(confusion_mat, p_val_vs_csp,
    ...
    if rotate_precision:
        ...
        rotation=0
        print("hi no rotate")
    ax.text(n_classes, -1.1, "Precision", ha='center', va='center',

...
"""
Copied from lasagne... should be removed eventually
"""
import theano
...
#### ADAPTED TO STILL TAKE NONLINEARITY ARGUMENT(!!)
# And also use_averages as member variable not as argument to function 
class BatchNormLayer(Layer):
    ...
    **kwargs
    ...
    def __init__(self, incoming, axes='auto', epsilon=1e-4, alpha=0.1,
                 ...
                 nonlinearity=identity, batch_norm_use_averages=None,
                 **kwargs):

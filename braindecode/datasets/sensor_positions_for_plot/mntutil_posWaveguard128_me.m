...
ea= a * [ 0 ...
          -3.5 3.5 ...% -4 -2 0 2 4 ... % -4 -1.5 0 1.5 4 ...
          -1 1 ...
          -4 -2 0 2 4 ...% -4 -3 -2 -1 0 1 2 3 4 ...% -4 -3 -2.5 -2 0 2 2.5 3 4 ...
          -2.5 -0.5 0.5 2.5 ...
          -4 -3 -2 -1 0 1 2 3 4 ...
...
eb= [   4*b * ones(1,1) ... 
      3.5*b * ones(1,2) ... % 3.5*b * ones(1,5) ...
      3.5*b * ones(1,2) ...
        3*b * ones(1,5) ... % 3*b * ones(1,9) ...
      2.5*b * ones(1,4) ...
        2*b * ones(1,9) ...
      1.5*b * ones(1,8) ...
        1*b * ones(1,11) ...
     ...
     -2.5*b * ones(1,6) ...
       -3*b * ones(1,11) ...
    -3.25*b * ones(1,4) ... % -3.5*b * ones(1,7) ...
    -3.75*b * ones(1,3) ... % -3.5*b * ones(1,7) ...
    -4.25*b * ones(1,2) ...
     -4.5*b * ones(1,3)]; % -5*b * ones(1,5)];
